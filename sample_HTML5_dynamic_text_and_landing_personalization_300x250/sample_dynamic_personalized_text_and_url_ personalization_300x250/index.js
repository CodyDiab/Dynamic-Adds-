function init() {
  ...
  xhr.open("GET", "https://epsilon.6sense.com/v3/company/details"); // The actual call made to company details api
  xhr.setRequestHeader("Authorization", "Token <Insert Token>"); // The company details api-token (provided by 6sense) goes here.
